...
import { ResearchRunSummary, useResearchRuns } from '../../../entities/research-run/index.ts';
import { Button, Card, Spinner } from '../../../shared/ui/index.ts';
import styles from './Panel.module.css';
import { ResearchRunDetail } from './ResearchRunDetail.tsx';

/** "Research runs" tab: paginated research-run list plus the selected run's detail. */
      ...
      <div className={styles.list}>
        {data.items.map((run) => (
          <ResearchRunSummary
            ...
            labels={{
              iterations: t('telemetry.iterations'),
              evidence: t('telemetry.evidence'),
